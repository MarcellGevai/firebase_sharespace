	...
	{#if currentUser}
		<div class="fixed bottom-6 left-6 z-40">
			<button 
				...
				class="bg-blue-600 hover:bg-blue-700 text-white h-14 rounded-full flex items-center shadow-lg shadow-blue-200 transition-all duration-300 active:scale-95 group overflow-hidden"
			...
			>
				...
				<div class="overflow-hidden transition-all duration-300 w-0 group-hover:w-24 flex items-center opacity-0 group-hover:opacity-100">
